...
class _NoteWorthyProjectsState extends State<NoteWorthyProjects>
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle? titleStyle = textTheme.bodySmall?.copyWith(
      ...
      fontSize: responsiveSize(context, Sizes.TEXT_SIZE_20, Sizes.TEXT_SIZE_30),
    );
...
class NoteWorthyProjectItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    TextTheme textTheme = Theme.of(context).textTheme;
    TextStyle? defaultNumberStyle = textTheme.bodySmall?.copyWith(
      fontSize: Sizes.TEXT_SIZE_16,
      color: AppColors.grey550,
      fontWeight: FontWeight.w400,
    );
    TextStyle? defaultSourceStyle = textTheme.bodySmall?.copyWith(
      fontSize: Sizes.TEXT_SIZE_16,
      color: AppColors.grey700,
      fontWeight: FontWeight.w400,
      decoration: TextDecoration.underline,
    );
    TextStyle? defaultProjectNameStyle = textTheme.bodySmall?.copyWith(
